...
const Pricing = () => {
  return (
  <>
<section className="flex items-center justify-center my-10 pb-10">
    ...
    <div className="isolate mx-auto grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div className="ring-1 ring-gray-200 rounded-3xl p-8 xl:p-10">
       ...
       <span className="text-5xl font-bold tracking-tight text-gray-900">$0</span>
        ...
        <Link href={'/dashboard'} aria-describedby="tier-standard" className="text-blue-600 ring-1 ring-inset ring-blue-200 hover:ring-blue-300 mt-6 block rounded-md py-2 px-3 text-center text-base font-medium leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600" target="_blank">Buy now</Link>
